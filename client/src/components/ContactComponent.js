...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            feedback: '', 
            touched: { // keeps track of whether these 4 fields have been touched or not. touched fields validation runs
                firstName: false,
                lastName: false,
                phoneNum: false,
                email: false
    ...
    handleBlur = (field) => () => { // fired when user touches a field. triggers form validation
        this.setState({
    ...
    handleInputChange(event) {
        ...
        this.setState({
            [name]: value // used from value variable on line 27
        });
    }
